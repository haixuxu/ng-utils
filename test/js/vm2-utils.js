(function(angular, window, undefined) {
    ...
    /**
     //     Usage:
     //     <input type="text" vm-amount mode="12.2" ></input>
     //     <input type="text" vm-amount mode="12.2" symbol='$' formatting='true' ></input>
     //     All Usage(default):
     //     <input type="text" name="testabc" ng-model="testabc" vm-amount mode="12.2" decimals="2" formatting="true"  symbol='$'>
     */
    angular.module('vm2.utils').directive('vmAmount', ['$locale', function($locale) {
